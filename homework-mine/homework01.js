...
let line1 = 'I start to practice "JavaScript" today, and I like it.';
console.log(line1);

let line2 = 'The secret of getting ahead is getting started.';
console.log(line2);

let line3 = `"Don't limit yourself. "`;
console.log(line3);

let line4 = 'Invest in your dreams. Grind now. Shine later.';
console.log(line4);

let line5 = `It's not the load that breaks you down, it's the way you carry it.`;
console.log(line5);

let line6 = 'The hard days are what make you stronger.';
console.log(line6);

let line7 = 'You can waste your lives drawing lines. Or you can live your life crossing them.';
console.log(line7);
...
console.log('My height is',myHeight,'ft');
console.log('My weight is',myWeight,'lbs');
